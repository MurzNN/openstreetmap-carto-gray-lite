@admin-boundaries: @gray-lite_dark-1; // Lch(47,30,327)
@admin-boundaries-narrow: @gray-lite_dark-2; // Lch(42,35,327)
@admin-boundaries-wide: @gray-lite_dark-2; // Lch(57,25,327)
